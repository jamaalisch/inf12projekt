...
wort = getpass("Gib ein beliebiges Wort an, welches mehrere Buchstaben hat: \n").lower()                                                                    # Eingabe eines Worts, welches versteckt wird. Alle Buchstaben werden klein gemacht
...
while n > 0 and not wort_erraten:
    ...
    if buchstabe in geratene_buchstaben:                                                                                                                    # Überprüfung, ob ein Buchstabe bereits geraten wurde
        print("Du hast diesen Buchstaben bereits geraten. \nDu Idiot. \nDu bekommst für deine Dummheit 1 Versuch abgezogen. Jetzt mach mal richtig.")
        n -= 1
